...
const SignupPage: React.FC = () => {
  ...
  const handleEmailSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setStatus('Account created (demo).');
  };
      ...
      <main className="flex items-center justify-center px-6 py-12">
        <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          <h1 className="text-4xl font-extrabold text-white leading-snug">
            Join thousands worldwide who chat with their videos using <span className="text-emerald-400">Thumio.</span>
            </h1>
          ...
          <div className="bg-[#0f131a] border border-gray-800 rounded-2xl shadow-2xl p-8 max-w-md w-full justify-self-end">
            <div className="space-y-6">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                By signing up, you agree to Thumio&apos;s{' '}
